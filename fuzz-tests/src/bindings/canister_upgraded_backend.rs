...
pub struct CanisterUpgradedBackendCanister {
    pub canister_id: Principal,
    pub caller: super::Caller,
}

impl CanisterUpgradedBackendCanister {
...
pub fn new(caller: &super::Caller, canister_id: Principal) -> CanisterUpgradedBackendCanister {
    CanisterUpgradedBackendCanister {
        canister_id,
        caller: caller.clone(),
    }
}

pub fn deploy(deployer: &super::Deployer) -> super::DeployBuilder<CanisterUpgradedBackendCanister> {
    let args = Encode!();
...
pub fn wasm() -> Option<Vec<u8>> {
    ...
    path.push("../target/wasm32-wasip1/release/canister_upgraded_backend_nowasi.wasm");
